//
// Created by Bartek Tonia on 09.03.18.
//
...
int main(int argc, char* argv[]){
    ...
    void* staticH = dlopen ("./static.so", RTLD_LAZY);
    void* dynamicH = dlopen ("./dynamic.so", RTLD_LAZY);
    //DYANMIC
    char ** newTableCalloc(int, size_t) = dlsym(dynamicH, "newTableCalloc");
    void freeTableCalloc(char **, int ) = dlsym(dynamicH,"freeTableCalloc");
    void delBlockCalloc(char** , int )= dlsym(dynamicH,"delBlockCalloc");
    void addBlockCalloc(char** , int , size_t)= dlsym(dynamicH,"addBlockCalloc");
    char* findCalloc(char **, int , int , size_t)= dlsym(dynamicH,"findCalloc");
    //STATIC
    char ** newTableStatic(int, size_t) = dlsym(staticH, "newTableStatic");
    void freeTableStatic(int ) = dlsym(staticH,"freeTableStatic");
    void delBlockStatic( int , size_t)= dlsym(staticH,"delBlockStatic");
    void addBlockStatic( int , size_t )= dlsym(staticH,"addBlockStatic");
    char* findStatic(int , int, size_t)= dlsym(staticH,"findStatic");
